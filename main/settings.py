...
FERNET_SECRET_KEY = passthrough(env('FERNET_SECRET_KEY'))
...
# ASGI_APPLICATION = 'main.asgi.application'  # uncomment if needed
...
# 		'main.settings.CsrfExemptSessionAuthentication',
